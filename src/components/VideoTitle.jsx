...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="absolute top-0 left-0 w-full h-9/12 sm:h-[70vh] md:h-[80vh] lg:h-screen z-10 bg-gradient-to-t from-black via-black/50 to-transparent flex flex-col justify-center px-4 sm:px-8 md:px-12">
      <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold">
        {title}
      </h1>

      <p className="py-1 text-sm sm:text-base md:text-lg max-w-lg line-clamp-3">
        {overview}
      </p>
